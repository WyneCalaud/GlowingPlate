...
# ==========================================================
# UPDATE (FORMULA BASED)
# ==========================================================

func update_concept_progress(concept: String, is_correct: bool, response_time: float, current_day: int) -> int:
	...
	if not is_correct:
		# 🔥 ALWAYS FORCE NEXT DAY IF WRONG
	...
	# --- DEBUG ---
	print("📊 CONCEPT UPDATE")
	print("Concept:", concept)
	print("C:", C, "I:", I, "E:", E, "S:", S)
	print("Mastery:", M)
